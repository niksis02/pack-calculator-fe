    ...
    <nav className="bg-blue-700 text-white shadow-md">
      <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          <a
            href="https://github.com/niksis02/pack-calculator-fe"
            target="_blank"
          ...
          <a
            href="https://github.com/niksis02/pack-calculator-be"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-sm hover:text-blue-200 transition-colors"
          ...
          <a
            href="https://github.com/niksis02/pack-calculator-setup"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-sm hover:text-blue-200 transition-colors"
            aria-label="Setup GitHub repository"
          >
            <GitHubIcon />
